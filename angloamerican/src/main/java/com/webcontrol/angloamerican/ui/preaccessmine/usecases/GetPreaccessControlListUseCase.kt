...
class GetPreaccessControlListUseCase @Inject constructor(private val repository: IPreaccessMineRepository) {
    suspend operator fun invoke(preaccessId: Int) = repository.getPreaccessControlList(preaccessId)
}